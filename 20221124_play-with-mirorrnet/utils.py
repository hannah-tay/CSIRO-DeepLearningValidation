# from https://github.com/Project-MONAI/tutorials/blob/main/deep_atlas/utils.py
...
def preview_image(image_array, normalize_by="volume", cmap=None, figsize=(12, 6), threshold=None):
    """
